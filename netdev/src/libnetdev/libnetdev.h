...
// Maximum length for ip prefix addition in CIDR notation. Since Ipv6 can have a prefix length of up
// to 3 digits, we define a maximum length of 4 to accommodate the prefix and the null terminator.
